        ...
        <div>
            <header id="nav">
                ...
                <h1>Connections</h1>
                    ...
                    <Link to="/">
                        ...
                        <Link to="/creations">
                            <li className="unselected">Book</li>
                        </Link>
                        <Link to="/contact">
            ...
            <h1>Contact Us</h1>
                <form name="contact" method="post">
                    ...
                    <br />
                    <br />
                    <textarea required className="text" placeholder="Comments" cols="18" rows="4" name="text" value={text} onChange={(e) => {setText(e.target.value)}}/>
                    <br />
                    <br />
